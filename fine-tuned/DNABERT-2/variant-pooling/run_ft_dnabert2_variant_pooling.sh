...
POOL_SCRIPT_DIR=/fine-tuned/DNABERT-2/variant-pooling
POOL_PY="${POOL_SCRIPT_DIR}/ft_dnabert2_variant_pooling.py"
...
print(f"Merged output saved: ${FINAL_OUT}")
