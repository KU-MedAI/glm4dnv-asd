...
class NCRERegressionDataset(Dataset):
    def __init__(self, df, tokenizer, seq_col="NCREs_seq", label_col="activity_score", max_len=1024):
...
def main():
    ...
    logging.info("Max length = %d", max_len)
    ...
    # ============================================================
    # Model setup - REGRESSION MODE
    # ============================================================
    logging.info("Loading model in REGRESSION mode (num_labels=1)")
    ...
    if args.use_lora:
        ...
        logging.info(
            ...
            targets, args.lora_r, alpha, args.lora_dropout,
        )
